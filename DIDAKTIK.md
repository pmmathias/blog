...
| 2026-04-20 | **Interferenz-Kick: „Interferenz existiert" ist kein Speedup-Beweis.** Wer zeigt, dass 2×Hadamard zu \|0⟩ zurückführt, hat *nur* gezeigt, dass klassische Wahrscheinlichkeit das nicht kann — nicht, *wie* Interferenz in einem Algorithmus die richtige Antwort verstärkt. Das ist der eigentliche Aha. Pflicht: mindestens ein konkretes Beispiel mit Amplituden-Dynamik (Grover-Balken vor/nach Oracle/nach Diffusion) im Blog UND im Video, bevor über Shor/Grover als Anwendungen gesprochen wird. Falsches Bild zuerst explizit zerstören: „QC probieren nicht alle Möglichkeiten parallel aus" — Messung kollabiert alles. Kernsatz: *Klassisch durchsucht, Quantum formt.* | Externes Review zum Quantencomputer-Post |
| 2026-04-20 | **Hooks öffnen, nicht erklären.** YouTube-Retention für „Vom Aktienkurs zum Sprachmodell" lag bei 14 % (65 s von 481 s). Der alte Hook („Was macht ChatGPT eigentlich? … Es sagt das nächste Wort voraus. Nicht mehr, nicht weniger.") war passiv und flapsig. Der neue Hook etabliert in 25 s: (1) ein konkretes greifbares Artefakt (Browser-Chatbot ohne GPU/NN), (2) drei Welten-Teaser (ChatGPT + Google + Schrödinger), (3) einen Konvergenz-Moment (alle drei Pfeile treffen in „Eigenwerte"), (4) eine explizite Promise („Buckle up"). Die ersten 25 Sekunden entscheiden über die Retention des gesamten Videos. Kein „Nothing more, nothing less" und keine passiven Fragen als Eröffnung. | Eigenwerte-Video-Rework |
